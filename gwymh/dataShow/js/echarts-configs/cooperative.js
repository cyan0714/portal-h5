// 折柱混合
const lineBarC1 = echarts.init(document.getElementById('cooperative-censusDetails3'))
const lineBarC2 = echarts.init(document.getElementById('cooperative-chartsTotal1'))
...
lineBarC2.setOption(lineBarC2Options)

nestLoopC1.setOption(nestLoopC1Option)
